                                    ...
                                    <?php foreach ($data['tawar'] as $miw=> $isi) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= APLIKASI; ?>/tawar/edit/<?= $isi['id']; ?>" button class="btn btn-warning btn-sm"> EDIT </button> </a>

                                            </td>
                                            <td class="text-center">

                                                <a href="<?= APLIKASI; ?>/tawar/hapus/<?= $isi['id']; ?>" button class="btn btn-danger btn-sm"> DELETE </button> </a>

                                            </td>
                                            <td>

                                                <a href="<?= APLIKASI; ?>/terima/input/<?= $isi['id']; ?>" button class="btn btn-danger btn-sm"> PESANAN </button> </a>

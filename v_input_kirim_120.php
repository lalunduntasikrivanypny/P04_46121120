...
<body class="bg-theme bg-theme1">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?= APLIKASI; ?>/barang/input" button class="btn btn-dark mt-3 btn-sm"> SIMPAN </button> </a>
                            <table class="table table-bordered table-striped" border="10" width="75%">

                                <a align="right" href="<?= APLIKASI; ?>/terima/index" button class="btn btn-outline-dark float-end mt-3 btn-sm"> KEMBALI </button> </a>
                                <table class="table table-bordered table-striped" border="10" width="75%">
                        </div>
                    </div>
                </div>
	...
	<!--end wrapper-->
	<!--start switcher-->
	<?php ("aplikasi/views/bagian/bagian_samping_kanan.php");?>
	<!--end switcher-->
	<!-- Bootstrap JS -->

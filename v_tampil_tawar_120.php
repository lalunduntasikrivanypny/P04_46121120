                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header bg-dark text-white">
                            <h1 align="left"><strong>TAMPILKAN PENAWARAN</strong></h1>
                        </div>
                        <div class="card-body bg-secondary text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" id="nwn" class="form-control" value="<?= $data["tawarid"]["nomor_penawaran"]; ?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" value="<?= $isi["alamat"]; ?>">
                                </div>
                            </div>

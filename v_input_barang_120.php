                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header bg-secondary text-white">
                            <h2 align="center"><strong>INPUT BARANG</i></strong></h2>
                        </div>
                    </div>
                    <div class="card-body bg-warning">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input id="harga_estimasi" type="text" class="form-control">
                        </div>

                        <div class="form-group mb-4">
                            <h6 label for="" style="color:black"><strong>Sheet</strong></label></h6>
                            <input id="berat_bersih" type="text" class="form-control">
                        </div>

                        <div class="form-group mb-4">
                            <h6 label for="" style="color:black"><strong>Merek</strong></label></h6>
                            <input id="kode_produksi" type="text" class="form-control">
                        </div>
                    </div>

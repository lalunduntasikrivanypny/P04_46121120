                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body bg-secondary text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" id="nopen" class="form-control" value="<?= $data["tawarid"]["nomor_penawaran"]; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <select class="form-select">
                                        <?php foreach ($data['pelanggan'] as $miw => $isi) : ?>
                                            <option value="<?= $isi['id']; ?>"><?= $isi['kode_pelanggan']; ?>/<?= $isi['nama_pelanggan']; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" id="alt" value="<?= $isi["alamat"]; ?>">
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                                            ...
                                            <td>
                                                <center>
                                                    <div class="form-group row">
                                                        <div class="col">
                                                            <input type="text" class="form-control-center" value="<?= $isi['harga_estimasi']; ?>">
                                                        </div>
                                                    </div>
                                                </center>
                                            </td>
                            ...
                            <a href="<?= APLIKASI; ?>/barang/input" button class="btn btn-dark mt-3"> UPDATE </button> </a>
...
<div class="modal fade" id="edit_tawar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                        ...
                                        <?php foreach ($data['barang'] as $miw => $isi) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="<?= APLIKASI; ?><?= $isi['id']; ?>" button class="btn btn-primary btn-sm"> PILIH </button> </a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                ...
                                <div class="modal-footer">
                                    <button> <a href="<?= APLIKASI; ?>/tawar/edit" type="button" class="button"> <b>TUTUP</b> </button> </a>
                                </div>
                            </div>
...
<script>
    ...
    $("#kdp").change(function() {
        // alert("ada masalah apa? yukk Cerita")

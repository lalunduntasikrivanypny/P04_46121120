                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body bg-gradient-success text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="date" class="form-control" value="<?= $data["terimaid"]["tgl_penawaran"]; ?>">
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="input_tawar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <div class="modal-footer">
                                    <button> <a href="<?= APLIKASI; ?>/terima/edit" type="button" class="button btn-sm"> <b>TUTUP</b> </button> </a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    $("#kdp").change(function() {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function(ate) {
                // console.log(ate);

                $("#alt").val(ate.pelanggan.alamat)
            }
        })
    })
</script>
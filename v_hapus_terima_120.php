                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-footer">
                            <button type="button" class="button float-end" data-bs-dismiss="modal">CARI</button>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-dark mt-3"> HAPUS </button> </a>
...
<div class="modal fade" id="delete_tawar" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-body">
                                ...
                                <div class="modal-footer">
                                    <button> <a href="<?= APLIKASI; ?>/terima/hapus" type="button" class="button btn-sm"> <b>TUTUP</b> </button> </a>
                                </div>
                            </div>

...
<body class="bg-theme bg-theme1">
	...
	<div class="wrapper">
		...
		<!--end sidebar wrapper -->
		<!--start header -->
		<?php ("aplikasi/views/bagain/bagian_atas.php");?>
		<!--end header -->
		<!--start page wrapper -->
	<!--start content-->
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-header bg-dark text-white">
                            <h1 align="left"><strong>LIHAT PENGIRIMAN</strong></h1>
                        </div>
                        <div class="card-body bg-info text-dark bg-opacity-25">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" value="<?= $data["kirim"]["nomor_penawaran"]; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-6">
                                    <input type="text" class="form-control " value="<?= $data["kirim"]["nama_pelanggan"]; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="date" class="form-control" value="<?= $data["kirim"]["tgl_penawaran"]; ?>">
                                </div>
                            </div>

                                <label for="" class="col-4" style="color:black" align="right"> <strong>TGL TERIMA PESANAN</strong></label>
                                <div class="col-3">
                                    <input type="date" class="form-control" value="<?= $data["kirim"]["tgl_pesanan"]; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-3">
                                    <input type="text" class="form-control" value="<?= $data["kirim"]["tgl_pengiriman"]; ?>" readonly>
                                </div>
                                </div>

                                <label for="" class="col-4" style="color:black" align="right"> <strong>EXPEDISI</strong></label>
                                <div class="col-3">
                                    <input type="text" class="form-control" value="<?= $data["kirim"]["expedisi"]; ?>" readonly>
                                </div>
                            </div>
	...
	<!--end wrapper-->
	<!--start switcher-->
	<?php ("aplikasi/views/bagian/kanan.php");?>
	<!--end switcher-->
	<!-- Bootstrap JS -->

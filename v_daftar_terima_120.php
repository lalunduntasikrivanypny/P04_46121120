                                    ...
                                    <?php foreach ($data['terima'] as $miw=> $isi) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?= APLIKASI; ?>/terima/edit/<?= $isi['id']; ?>" button class="btn btn-warning btn-sm"> EDIT </button> </a>

                                            </td>
                                            <td class="text-center">

                                                <a href="<?= APLIKASI; ?>/terima/hapus/<?= $isi['id']; ?>" button class="btn btn-danger btn-sm "> DELETE </button> </a>

                                            </td>
                                            <td class="text-center">

                                                <a href="<?= APLIKASI; ?>/kirim/input/<?= $isi['id']; ?>" button class="btn btn-danger btn-sm"> KIRIM </button> </a>
